...
class LoginApp:
    def __init__(self, root):
        ...
        login_frame = tk.Frame(root, bg="#333333", bd=0, relief="flat")  # Changed to solid color, Tkinter does not support alpha
        login_frame.place(relx=0.65, rely=0.5, anchor="center", width=280, height=220)
